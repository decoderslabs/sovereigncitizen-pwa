...
!function(o) {
    ...
    D.fn.TouchSpin = function(k) {
        ...
        return this.each(function() {
            ...
            function h() {
                var t, n, o;
                "" !== (t = i.callback_before_calculation(c.val())) ? 0 < i.decimals && "." === t || (n = parseFloat(t),
                ...
                c.trigger("change"))) : "" !== i.replacementval && (c.val(i.replacementval),
                c.trigger("change"))
            }
            function v() {
                if (i.booster) {
                    var t = Math.pow(2, Math.floor(d / i.boostat)) * i.step;
                    return i.maxboostedstep && t > i.maxboostedstep && (t = i.maxboostedstep,
                    a = Math.round(a / t) * t),
                    Math.max(i.step, t)
                }
                return i.step
            ...
            !function() {
                if (c.data("alreadyinitialized"))
                    return;
                if (c.data("alreadyinitialized", !0),
                N += 1,
                c.data("spinnerid", N),
                !c.is("input"))
                ...
                function() {
                    ...
                    n.hasClass("input-group") ? function(t) {
                        ...
                        var n, o, s = c.prev(), p = c.next(), a = '<span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix input-group-prepend bootstrap-touchspin-injected"><span class="input-group-text">' + i.prefix + "</span></span>", e = '<span class="input-group-addon input-group-append bootstrap-touchspin-postfix input-group-append bootstrap-touchspin-injected"><span class="input-group-text">' + i.postfix + "</span></span>";
                        s.hasClass("input-group-btn") || s.hasClass("input-group-prepend") ? (n = '<button class="' + i.buttondown_class + ' bootstrap-touchspin-down bootstrap-touchspin-injected" type="button">' + i.buttondown_txt + "</button>",
                        s.append(n)) : (n = '<span class="input-group-btn input-group-prepend bootstrap-touchspin-injected"><button class="' + i.buttondown_class + ' bootstrap-touchspin-down" type="button">' + i.buttondown_txt + "</button></span>",
                        D(n).insertBefore(c));
                        p.hasClass("input-group-btn") || p.hasClass("input-group-append") ? (o = '<button class="' + i.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + i.buttonup_txt + "</button>",
                        p.prepend(o)) : (o = '<span class="input-group-btn input-group-append bootstrap-touchspin-injected"><button class="' + i.buttonup_class + ' bootstrap-touchspin-up" type="button">' + i.buttonup_txt + "</button></span>",
                        D(o).insertAfter(c));
                        D(a).insertBefore(c),
                        D(e).insertAfter(c),
                        u = t
                ...
                c.on("keydown.touchspin", function(t) {
                    ...
                    38 === n ? ("up" !== f && (g(),
                    _()),
                    t.preventDefault()) : 40 === n && ("down" !== f && (m(),
                    w()),
                    t.preventDefault())
                }),
                ...
                c.on("blur.touchspin", function() {
                    h(),
                    c.val(i.callback_after_calculation(c.val()))
                }),
                ...
                c.on("touchspin.destroy", function() {
                    !function() {
                        ...
                        y(),
                        c.off(".touchspin"),
                        t.hasClass("bootstrap-touchspin-injected") ? (c.siblings().remove(),
                        c.unwrap()) : (D(".bootstrap-touchspin-injected", t).remove(),
                ...
                c.on("touchspin.updatesettings", function(t, n) {
                    !function(t) {
                        ...
                        h();
                        var n = p.input.val();
                        "" !== n && (n = Number(i.callback_before_calculation(p.input.val())),
